...
# set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports { IOPortD[0] }]; #IO_L5N_T0_34               ,Sch=SW12
# set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports { IOPortD[1] }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { IOPortD[0] }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
set_property -dict { PACKAGE_PIN R2   IOSTANDARD LVCMOS33 } [get_ports { IOPortD[1] }]; #IO_L1P_T0_34               ,Sch=SW15
...
# set_property -dict { PACKAGE_PIN W3   IOSTANDARD LVCMOS33 } [get_ports { IOPortD[0] }]; #IO_L6N_T0_VREF_34            ,Sch=LED10
# set_property -dict { PACKAGE_PIN U3   IOSTANDARD LVCMOS33 } [get_ports { IOPortD[1] }]; #IO_L9P_T1_DQS_34             ,Sch=LED11
...
set_property -dict { PACKAGE_PIN P1   IOSTANDARD LVCMOS33 } [get_ports { IOPortD[2] }]; #IO_L19N_T3_VREF_35           ,Sch=LED14
set_property -dict { PACKAGE_PIN L1   IOSTANDARD LVCMOS33 } [get_ports { IOPortD[3] }]; #IO_L6N_T0_VREF_35            ,Sch=LED15
